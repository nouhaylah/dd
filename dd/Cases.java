        ...
        for (int i = 0; i < 7; i++) {
            for (int j = 0; j < 7; j++) 
                //CASES DEPART
                    ...
                    //CASES CHANCE
                    else if((i==5 && j==1)||(i==5 && j==5)||(i==1 && j==1)||(i==1 && j==5)||(i==3 && j==3)||(i==3 && j==0)||(i==3 && j==6)){
                        if((i==5 && j==1)){
                    ...
                    //CASES MALCHANCE
                    else if((i==2 && j==2)||(i==2 && j==4)||(i==4 && j==2)||(i==4 && j==4)||(i==1 && j==3)||(i==5 && j==3)||(i==0 && j==1)||(i==0 && j==5)){
                        if((i==2 && j==2)){
                    ...
                    //CASES COMBAT
                    else if((i==2 && j==3)||(i==4 && j==3)||(i==2 && j==1)||(i==4 && j==5)||(i==2 && j==6)||(i==4 && j==0)){
                        plateau[i][j]=new Case(i,j,Color.green,"COMBAT");
                    }
                    //CASES ENIGME
                    else if((i==3 && j==2)||(i==3 && j==4)||(i==4 && j==1)||(i==2 && j==5)||(i==2 && j==0)||(i==4 && j==6)){
                        if(i==3 && j==2){
